...
const CATEGORIES = [
    { value: 'aerial-platforms', label: 'Aerial Platform Platform Systems (无人机系统)' },
    { value: 'detection-monitoring', label: 'Target Detection & Monitoring / Airspace Monitoring (无人机探测与空域监控)' },
