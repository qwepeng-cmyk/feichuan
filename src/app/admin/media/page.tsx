                                        ...
                                        <td style={{ padding: '14px 22px', textAlign: 'right' }}>
                                            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '8px' }}>
                                                {publicVisible ? (
                                                    ...
                                                    <Link href={`/admin/media/${article.id}/preview`} target="_blank" style={{ display: 'inline-flex', alignItems: 'center', gap: '5px', padding: '7px 14px', backgroundColor: '#f8fafc', color: '#94a3b8', borderRadius: '7px', textDecoration: 'none', fontSize: '1.25rem', fontWeight: 600 }}>
                                                        <Eye size={14} /> Preview
                                                    </Link>
                                                )}
