    ...
    return (
        <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '28px' }}>
                <h1 style={{ fontSize: '2.0rem', color: '#1e293b', fontWeight: 700, letterSpacing: '-0.2px' }}>方案管理</h1>
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                        <thead>
                            <tr style={{ borderBottom: '1px solid #edf0f4' }}>
                                ...
                                <th style={{ padding: '13px 22px', color: '#8896a6', fontWeight: 500, fontSize: '1.3rem', letterSpacing: '0.3px' }}>方案名称</th>
                                ...
                                <tr key={p.handle} style={{ borderBottom: '1px solid #f4f6f8', transition: 'background 0.15s' }}
                                    ...
                                    <td style={{ padding: '14px 22px', textAlign: 'right' }}>
                                        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '8px' }}>
                                            <Link href={`/solutions/${p.handle}`} target="_blank" style={{ 
                                            ...
                                            <Link href={`/admin/solutions/${p.handle}`} style={{ 
                                                display: 'inline-flex', alignItems: 'center', gap: '5px', 
