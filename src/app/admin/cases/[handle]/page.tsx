...
export default function CaseEditPage({ params }: { params: { handle: string } }) {
    ...
    const save = async () => {
        ...
        try {
            ...
            if(j.success){setOk('Saved!');setTimeout(()=>router.push('/admin/cases'),1200)}
    ...
    return (
        <div style={{maxWidth:'1100px',margin:'0 auto'}}>
            ...
            {error&&<div style={{padding:'14px 20px',backgroundColor:'#fff5f5',color:'#c53030',borderRadius:'10px',marginBottom:'20px',border:'1px solid #fed7d7',fontSize:'1.4rem'}}>{error}</div>}
            {ok&&<div style={{padding:'14px 20px',backgroundColor:'#f0fff4',color:'#276749',borderRadius:'10px',marginBottom:'20px',border:'1px solid #c6f6d5',fontSize:'1.4rem'}}>{ok}</div>}
