                            ...
                            {cases.map((caseItem) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <td style={{ padding: '14px 22px' }}>
                                            <span aria-label={published ? 'Case is published' : 'Case is offline'} style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', padding: '6px 11px', borderRadius: '999px', border: `1px solid ${published ? '#bbf7d0' : '#fecdd3'}`, backgroundColor: published ? '#f0fdf4' : '#fff1f2', color: published ? '#15803d' : '#be123c', fontSize: '1.2rem', fontWeight: 700 }}>
