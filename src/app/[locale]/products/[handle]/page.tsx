          ...
          <div className="container" style={{ padding: '40px 15px' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '40px' }}>
              ...
              <div style={{ padding: '20px 0' }}>
                <div style={{ height: '40px', backgroundColor: '#f0f0f0', width: '70%', marginBottom: '20px' }} />
                <div style={{ height: '16px', backgroundColor: '#f5f5f5', width: '90%', marginBottom: '10px' }} />
                <div style={{ height: '16px', backgroundColor: '#f5f5f5', width: '80%', marginBottom: '40px' }} />
                <div style={{ display: 'flex', gap: '20px' }}>
                  <div style={{ flex: 1, height: '50px', backgroundColor: '#f0f0f0' }} />
                  <div style={{ flex: 1, height: '50px', backgroundColor: '#f0f0f0' }} />
                </div>
              </div>
            </div>
