...
const solutionLinks = {
  en: [
    ...
    { title: "Chemical Plant C-UAS Protection", href: "/solutions/chemical-plant-protection" },
    { title: "Oil Production Base C-UAS Protection", href: "/solutions/oil-production-base-protection" },
    ...
    { title: "Airport C-UAS Security", href: "/solutions/airport-security-protection" },
  ],
  ru: [
