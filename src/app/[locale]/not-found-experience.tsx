...
const solutionLinks = {
  ...
  ru: [
    { title: "Защита критической инфраструктуры от воздушная платформаов", href: "/solutions/critical-infrastructure-airspace-monitoring" },
    { title: "Защита электростанций от воздушная платформаов", href: "/solutions/power-plant-airspace-monitoring" },
    { title: "Защита аэропортов от воздушная платформаов", href: "/solutions/airport-security-protection" },
    { title: "Защита границ от воздушная платформаов", href: "/solutions/border-airspace-monitoring" },
    { title: "Мониторинг воздушная платформаов для общественной безопасности", href: "/solutions/public-safety-airspace-monitoring" },
    { title: "Мониторинг воздушная платформаов в исправительных учреждениях", href: "/solutions/correctional-facility-airspace-monitoring" },
    { title: "Защита портов от воздушная платформаов", href: "/solutions/port-airspace-monitoring" },
    { title: "Защита массовых мероприятий от воздушная платформаов", href: "/solutions/mass-event-airspace-monitoring" },
    { title: "Мониторинг воздушная платформаов для VIP-объектов и частной собственности", href: "/solutions/vip-private-property-airspace-monitoring" },
    { title: "Защита предприятий от воздушная платформаов", href: "/solutions/enterprise-airspace-monitoring" },
  ],
  es: [
