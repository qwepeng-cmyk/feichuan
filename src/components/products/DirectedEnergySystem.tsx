...
import content from '@/content/directedEnergySystem.json';
import styles from './DirectedEnergySystem.module.css';

type VariantId = '2kw' | '3kw' | '5kw';
type PageMode = 'preview' | 'public';

interface DirectedEnergySystemProps {
  mode?: PageMode;
  locale?: string;
}
...
export default function DirectedEnergySystem({
  mode = 'preview',
  locale = 'ru',
}: DirectedEnergySystemProps) {
          ...
          <div className={styles.heroLayout}>
            ...
            <div className={styles.heroVisual}>
              ...
              <Image
                ...
                alt={`${activeVariant.power} anti-platform laser defense configuration`}
                fill
                priority
