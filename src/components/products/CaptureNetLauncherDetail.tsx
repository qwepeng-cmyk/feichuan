...
import styles from './CaptureNetLauncherDetail.module.css';
            ...
            <div>
              ...
              <div className={styles.heroActions}>
                ...
                <PrimaryContactButton
                  sourceLabel="handheld_platform_net_launcher_hero"
                  productName={name}
                  productHandle="handheld-capture-launcher"
...
function EvidenceSection({ copy, images, videos, name }: { copy: typeof COPY.ru; images: string[]; videos: GalleryVideo[]; name: string }) {
  return (
...
export default function platformNetLauncherDetail({ product, locale, dict }: { product: any; locale: Locale; dict: any }) {
