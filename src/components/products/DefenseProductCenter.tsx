...
import styles from './DefenseProductCenter.module.css';
...
export default function DefenseProductCenter({
  products,
  opticalProducts,
  locale,
  dict,
  ...
  const t = (value: string) => defenseText(locale, value);
  ...
  return (
    <div className={styles.page}>
      <section className={styles.banner}>
        <Image
          src="/solutions/defense-applications/banner/product_center_banner.webp"
          fill
          sizes="100vw"
          className={styles.bannerImage}
          priority
          alt={t('Professional Low-Altitude Defense detection and airspace monitoring equipment')}
        />
        <div className={styles.bannerOverlay} />
        <div className="container">
          <div className={styles.bannerCopy}>
            <h1>{t('Professional Low-Altitude Defense Equipment')}</h1>
            <p>{t('Browse N-TET portable, fixed-site, vehicle-mounted and platform-based Low-Altitude Defense equipment for detection, identification, tracking and low-altitude airspace management.')}</p>
          </div>
        </div>
      ...
      <div className={styles.productLists}>
        <section id="portable-defense-devices" className={styles.categorySection}>
          <div className="container">
        ...
        <section id="fixed-site-defense-systems" className={styles.categorySection}>
          <div className="container">
            <div className={styles.sectionTitle}>
        ...
        <section id="vehicle-mounted-defense" className={styles.categorySection}>
          <div className="container">
            <div className={styles.sectionTitle}>
        ...
        <section id="defense-control-platform" className={styles.categorySection}>
          <div className="container">
            <div className={styles.sectionTitle}>
...
function CustomConfigurationCard({
  ...
  const useComputerFrame = item.id === 'defense-control-platform';
  const t = (value: string) => defenseText(locale, value);
