                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr 1fr 1.2fr', gap: '60px', marginBottom: '60px' }}>
                    ...
                    <div>
                        ...
                        <ul style={{ display: 'flex', flexDirection: 'column', gap: '12px', fontSize: '1.4rem' }}>
                            ...
                            <li><Link prefetch={false} href={l("/products")} style={{ transition: 'color 0.3s' }} onMouseEnter={(e) => e.currentTarget.style.color = '#fff'} onMouseLeave={(e) => e.currentTarget.style.color = '#888'}>{dict.megaMenu.droneDetection}</Link></li>
                            ...
                            <li><Link prefetch={false} href={l("/products")} style={{ transition: 'color 0.3s' }} onMouseEnter={(e) => e.currentTarget.style.color = '#fff'} onMouseLeave={(e) => e.currentTarget.style.color = '#888'}>{dict.megaMenu.engineeringMaterials}</Link></li>
                    ...
                    <div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', fontSize: '1.4rem' }}>
                            <div>
                                ...
                                <a href={CONTACT_WHATSAPP_URL} target="_blank" rel="noopener noreferrer" style={{ color: '#888', fontWeight: 400, textDecoration: 'none' }}>{CONTACT_WHATSAPP_DISPLAY}</a>
                            </div>
                            <div>
