...
export default function Header() {
    ...
    // If it's home, transparency depends on scroll. If not home, it's always "scrolled" (solid white) style.
    const headerClass = `site-header ${(!isHome || scrolled) ? 'scrolled force-white' : 'transparent'}`;
