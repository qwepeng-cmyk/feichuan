...
import { defenseText, localizedefenseTree } from '@/lib/localeCopy';
import styles from './DefenseAboutPage.module.css';

const deliveryAreas = [
    {
        number: '01',
        icon: RadioTower,
        title: 'Low-Altitude Defense Equipment',
    ...
    },
    {
        ...
        text: 'Map-based awareness, device status, alerts and event records for connected Low-Altitude Defense equipment.',
    },
    {
        number: '04',
        icon: FileText,
...
const faqs = [
    {
        question: 'Can N-TET support a complete Low-Altitude Defense configuration?',
...
function DesktopdefenseAbout({ locale, dict }: { locale: string; dict?: any }) {
    return localizedefenseTree(locale, (
        <div className={styles.desktopPage}>
            <section className={styles.hero}>
                ...
                <div className={styles.shell}>
                    ...
                    <div className={styles.heroContent}>
                        ...
                        <h1>Low-Altitude Defense Equipment &amp; System Solutions</h1>
                        <p className={styles.heroLead}>
                            N-TET supplies Low-Altitude Defense equipment, multi-sensor system configurations and coordinated
            ...
            <main>
                    ...
                    <div className={`${styles.shell} ${styles.profileGrid}`}>
                        ...
                        <div className={styles.profileContent}>
                            ...
                            <div className={styles.profileCopy}>
                                <p>
                                    N-TET is a Beijing-based professional Low-Altitude Defense equipment and system supplier. We
                    ...
                    <div className={styles.shell}>
                        <div className={styles.sectionHeader}>
                            <div>
                                ...
                                <h2>Low-Altitude Defense equipment shaped around real deployment conditions.</h2>
                            </div>
                            <p>
                ...
                <FactoryShow locale={locale} dict={{ about: { factoryShowTitle: defenseText(locale, 'Equipment Preparation & Testing') } }} />
                ...
                <section className={styles.finalCta}>
                    ...
                    <div className={`${styles.shell} ${styles.finalCtaInner}`}>
                        <div>
                            <p>Plan a Low-Altitude Defense configuration</p>
...
function MobiledefenseAbout({ locale, dict }: { locale: string; dict?: any }) {
    return localizedefenseTree(locale, (
        <div className={styles.mobilePage}>
            <section className={styles.mobileHero}>
                ...
                <div className={styles.mobileHeroContent}>
                    ...
                    <div className={styles.mobileTitle} role="heading" aria-level={1}>Low-Altitude Defense Equipment &amp; System Solutions</div>
                    <span>Low-Altitude Defense equipment, system configuration and coordinated international delivery.</span>
            ...
            <main>
                <section className={styles.mobileProfile}>
                    ...
                    <h2>Equipment expertise carried through to delivery.</h2>
                    <p>
                        N-TET is a Beijing-based professional Low-Altitude Defense equipment and system supplier. We provide
...
export default function defenseAboutPage({ locale, dict }: { locale: string; dict?: any }) {
    return (
        <>
            <DesktopdefenseAbout locale={locale} dict={dict} />
            <MobiledefenseAbout locale={locale} dict={dict} />
        </>
    );
}
