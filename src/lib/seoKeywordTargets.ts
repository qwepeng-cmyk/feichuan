...
const TARGETS: Record<string, SeoKeywordTarget> = {
  ...
  '/about': {
    ...
    intro: 'N-TET is an industrial UAV systems integrator and solution provider focused on low-altitude monitoring equipment, inspection operations, and security technologies for infrastructure operators.',
    source: 'google_ads_keywords',
  },
  '/products': {
    primary: 'industrial UAV systems',
    secondary: ['UAV inspection drone', 'emergency response UAV', 'low altitude monitoring equipment', 'security screening systems', 'drone accessories', 'UAV components'],
    h1: 'Industrial UAV Systems & Field Equipment',
    overviewHeading: 'Industrial UAV Systems, Monitoring Equipment, Accessories, and Field Equipment',
    source: 'google_ads_keywords',
  },
  '/solutions': {
    primary: 'industrial UAV solutions',
    secondary: ['UAV inspection solutions', 'emergency response drone', 'critical infrastructure protection', 'key area security', 'low altitude monitoring'],
    h1: 'Industrial UAV Solutions and Low-Altitude Monitoring',
    overviewHeading: 'Industrial UAV Solutions for Inspection, Emergency Response, Low-Altitude Monitoring, and Security Operations',
    intro: 'N-TET lists UAV inspection solutions, drone power line inspection, pipeline inspection drones, water conservancy monitoring UAV operations, emergency response drone operations, search and rescue drone support, firefighting drone support, critical infrastructure protection, key area security, airport airspace monitoring, event security monitoring, and low-altitude monitoring solutions.',
    source: 'google_ads_keywords',
  },
  '/cases': {
    primary: 'UAV deployment cases',
    secondary: ['UAV inspection cases', 'power line UAV patrol', 'low altitude monitoring case', 'emergency support case', 'critical infrastructure protection', 'key area security'],
    h1: 'UAV Deployment Cases and Low-Altitude Monitoring References',
    overviewHeading: 'UAV Deployment and Low-Altitude Monitoring Cases',
    intro: 'Browse UAV deployment cases and low-altitude monitoring cases. References include power line UAV patrol, water conservancy UAV patrol, refinery monitoring cases, emergency support cases, airport airspace monitoring, event security monitoring, and low-altitude monitoring case examples.',
    source: 'google_ads_keywords',
  },
