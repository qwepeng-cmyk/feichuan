...
const TARGETS: Record<string, SeoKeywordTarget> = {
  '/': {
    ...
    secondary: ['C-UAS detection equipment', 'low altitude monitoring', 'UAV inspection drone', 'emergency response UAV'],
    h1: 'Industrial UAV & C-UAS Systems',
    overviewHeading: 'Industrial UAV Platforms and C-UAS Systems',
    intro: 'N-TET provides two core system lines for infrastructure and public-site operators: industrial UAV platforms for inspection and emergency missions, and C-UAS detection / low-altitude airspace monitoring systems for controlled sites.',
    source: 'google_ads_keywords',
  },
  '/about': {
    primary: 'industrial UAV and C-UAS systems integrator',
    secondary: ['low altitude monitoring solution provider', 'UAV system supplier', 'C-UAS detection equipment', 'security technology integrator'],
    h1: 'Industrial UAV & C-UAS Systems Integrator Profile',
    overviewHeading: 'Industrial UAV and C-UAS Integration Capabilities',
    intro: 'N-TET is an industrial UAV and C-UAS systems integrator focused on UAV platforms, low-altitude monitoring equipment, inspection operations, and security technologies for infrastructure operators.',
    source: 'google_ads_keywords',
  },
  '/products': {
    primary: 'industrial UAV and C-UAS equipment',
    secondary: ['C-UAS detection equipment', 'UAV inspection drone', 'emergency response UAV', 'low altitude monitoring equipment', 'security screening systems', 'UAV components'],
  ...
  '/solutions': {
    ...
    secondary: ['UAV inspection solutions', 'C-UAS detection solutions', 'emergency response drone', 'critical infrastructure protection', 'key area security', 'low altitude monitoring'],
    h1: 'Industrial UAV & C-UAS Solutions',
    overviewHeading: 'Industrial UAV Solutions for Inspection, Emergency Response, C-UAS Detection, and Security Operations',
    intro: 'N-TET lists UAV inspection solutions, C-UAS detection solutions, drone power line inspection, pipeline inspection drones, water conservancy monitoring UAV operations, emergency response drone operations, search and rescue drone support, firefighting drone support, airport airspace monitoring, event security monitoring, and low-altitude monitoring solutions.',
    source: 'google_ads_keywords',
  },
  '/cases': {
    primary: 'UAV and C-UAS deployment cases',
    secondary: ['UAV inspection cases', 'C-UAS monitoring case', 'power line UAV patrol', 'low altitude monitoring case', 'emergency support case', 'critical infrastructure protection'],
    h1: 'UAV & C-UAS Deployment Cases',
    overviewHeading: 'UAV Deployment and C-UAS Monitoring Cases',
    intro: 'Browse UAV deployment cases and C-UAS monitoring cases. References include power line UAV patrol, water conservancy UAV patrol, refinery monitoring cases, emergency support cases, airport airspace monitoring, event security monitoring, and low-altitude monitoring case examples.',
    source: 'google_ads_keywords',
  },
  ...
  '/solutions/oil-production-base-protection': {
    ...
    overviewHeading: 'Oil and Gas Drone Inspection Operations',
    intro: 'This oil and gas drone inspection solution supports oil production sites, pipeline corridor inspection, industrial facility inspection UAV operations, and low-altitude monitoring around field assets.',
    source: 'google_ads_keywords',
  },
  ...
  '/solutions/chemical-plant-protection': {
    ...
    intro: 'This page covers pipeline inspection drones, chemical plant monitoring, UAV pipeline inspection, and oil and gas drone inspection operations for petrochemical facilities.',
    source: 'google_ads_keywords',
  },
  ...
  '/contact': {
    ...
    secondary: ['UAV system supplier', 'C-UAS detection equipment', 'drone inspection solution', 'emergency response UAV', 'low altitude monitoring equipment'],
...
const CATEGORY_FALLBACKS: Record<string, string[]> = {
  ...
  'drone-detection': ['low altitude monitoring equipment', 'airspace monitoring system', 'C-UAS detection equipment'],
