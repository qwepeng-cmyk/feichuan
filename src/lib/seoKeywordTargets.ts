...
const TARGETS: Record<string, SeoKeywordTarget> = {
  ...
  '/solutions': {
    ...
    h1: 'Integrated C-UAS System Solutions',
    overviewHeading: 'C-UAS Detection, Identification, Tracking, and Airspace Monitoring',
    intro: 'N-TET organizes C-UAS solution workflows for airports, energy facilities, industrial operations, restricted public sites, and major venues, focusing on detection, identification, tracking, alert review, and site-level coordination.',
    source: 'google_ads_keywords',
  },
  '/solutions/low-altitude-airspace-monitoring': {
    ...
    overviewHeading: 'Multi-Sensor Drone Detector System Planning',
