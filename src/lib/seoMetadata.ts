...
const KEYWORD_BACKED_SEO: Record<string, SeoEntry> = {
  ...
  '/solutions/low-altitude-airspace-monitoring': {
    title: 'C-UAS and Anti Drone Detection Systems | N-TET',
    description:
      'C-UAS, counter-UAS, and anti drone detection systems combine RF drone detection, radar tracking, Remote ID monitoring, EO verification, and command-platform integration.',
    keywords: [
      'C-UAS and anti drone detection systems',
      'counter UAS system',
      'counter-UAS system',
  ...
  '/solutions/portable-drone-detection': {
    title: 'Portable Drone Detector | Handheld RF Detection | N-TET',
    description:
      'Compare portable and handheld passive RF drone detector options for patrols, temporary events, site surveys, mobile industrial coverage, and field-to-command response workflows.',
    keywords: [
