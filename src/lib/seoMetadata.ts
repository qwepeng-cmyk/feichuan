...
const KEYWORD_BACKED_SEO: Record<string, SeoEntry> = {
  ...
  '/solutions/low-altitude-airspace-monitoring': {
    ...
    description:
      'C-UAS and anti drone detection systems combine RF drone detection, radar tracking, Remote ID monitoring, EO verification, and command-platform integration.',
    keywords: [
