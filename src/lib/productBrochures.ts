...
const PRODUCT_BROCHURES: Record<string, ProductBrochure> = {
  ...
  'aerial-navigation-airspace-data-verification-system': {
    productName: 'Система навигационной верификации воздушного пространства',
    fileName: 'c-uas-signal-verification-system.pdf',
    downloadName: 'airspace-signal-verification-system-product-brochure.pdf',
    pageCount: 3,
  },
  ...
  'aerial-remote-id-monitoring-system': {
    productName: 'Система мониторинга Remote ID',
    fileName: 'uav-remote-id-recognition-system.pdf',
    downloadName: 'remote-id-recognition-system-product-brochure.pdf',
    pageCount: 4,
  },
  'handheld-integrated-multi-band-event-logging-directional-antenna-unit': {
    productName: 'Портативная мультидиапазонная система мониторинга',
    fileName: 'multiband-rf-detection-directional-antenna-unit.pdf',
    downloadName: 'multiband-rf-monitoring-unit-product-brochure.pdf',
    pageCount: 5,
  },
  'handheld-integrated-sdr-low-altitude-monitoring': {
    productName: 'Портативная интегрированная система мониторинга воздушного пространства',
    fileName: 'handheld-integrated-airspace-monitoring-system.pdf',
    downloadName: 'handheld-airspace-monitoring-system-product-brochure.pdf',
    pageCount: 3,
  },
