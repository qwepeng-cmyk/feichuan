...
export const perimeterDefenseLanding: IntentLandingConfig = {
  ...
  purpose:
    'Compare directional and omni-directional RF suppressors, fixed and portable RF detection, low-altitude target detection radar and EO/IR tracking for site perimeter protection.',
  heroImage: '/products/rf-systems/directional-rf-unit.webp',
  heroImageAlt: 'Perimeter defense system with directional RF suppression',
  heroFacts: ['Directional & omni RF suppressors', 'Fixed & portable RF detection', 'Integrated command platform'],
  applicationHeading: 'What defines an effective perimeter defense configuration?',
  answerBlock:
    'Perimeter defense for low-altitude protection is a multi-layered site security architecture. Fixed RF detectors and target detection radar monitor sector approach routes; Remote ID receivers log cooperative identity broadcasts; EO/IR tracking systems provide visual confirmation; and directional or omni-directional RF suppressors provide controlled signal suppression. System selection depends on site boundaries, terrain, building obstruction, electromagnetic environment, power and network infrastructure, and required response workflows. N-TET provides project-configured hardware, command integration software, site assessment and commissioning support for critical infrastructure, airports, industrial sites and high-security facilities.',
  applications: [
    { title: 'Industrial Facility Perimeter', summary: 'Continuous monitoring of approach sectors with fixed RF and radar layers linked to sector suppressors.' },
  ...
  products: [
    {
      ...
      summary: 'A project-configured directional RF suppression unit for focused sector coverage and site perimeter integration.',
      image: '/products/rf-systems/directional-rf-unit.webp',
      imageAlt: 'Directional RF Suppressor unit for perimeter defense',
    ...
    },
    {
      ...
      summary: 'A 360-degree RF suppression layer for fixed-site installation and automated command linkage.',
      image: '/products/rf-systems/omni-directional-rf-unit.webp',
      imageAlt: 'Omni-directional RF Suppressor for fixed perimeter coverage',
  ...
  comparisonHeading: 'Directional vs. Omni-directional perimeter response',
  comparisonIntro: 'Compare coverage geometry, installation requirements and operating concepts for fixed-site suppressors.',
  comparisonColumns: ['Directional RF Suppressor', 'Omni-directional RF Suppressor'],
  comparisonRows: [
    { label: 'Coverage Geometry', values: ['Focused sector / approach direction', '360-degree area coverage around fixed site'] },
    { label: 'Primary Operating Mode', values: ['Targeted sector suppression on alert', 'Area-wide suppression around facility core'] },
    { label: 'Site Planning Need', values: ['Sector drawings, aiming angle, exclusion zones', 'Facility radius, mounting height, nearby systems'] },
    { label: 'Command Handoff', values: ['Correlated track aiming + platform trigger', 'Automated / manual trigger via command platform'] },
  ],
  ...
  scenarios: [
    {
      ...
      summary: 'Fixed RF sensors, radar and directional suppressors protect production blocks and storage areas against low-altitude threats.',
      ...
      points: ['Multi-sector directional RF coverage', 'Continuous radar track generation', 'Standing command platform integration'],
    },
    {
  ...
  faqs: [
    { question: 'What components are required for a perimeter defense system?', answer: 'A basic configuration includes passive RF detection, target detection radar, command software and a directional or omni-directional RF suppressor selected for site geometry.' },
    { question: 'How is false alarm risk managed?', answer: 'Multi-sensor evidence correlation (RF + Radar + Remote ID) combined with EO/IR visual confirmation ensures operators verify targets before initiating suppressor response.' },
...
export const layeredSiteProtectionLanding: IntentLandingConfig = {
  ...
  answerBlock:
    'A practical Site Protection is a layered site-protection architecture rather than a single product. Fixed RF, radar, Remote ID and EO/IR equipment provides continuous detection, identification and tracking across planned sectors. Portable field units support temporary posts, patrol teams and event deployments. Vehicle-mounted configurations let teams reposition between operating points while maintaining sensor, platform and communications links. After target identification and visual confirmation, a Directional RF Suppressor can provide focused sector coverage or an Omni-directional RF Suppressor can provide 360-degree fixed-site coverage.',
  applications: [
  ...
  products: [
    {
      name: 'Portable Low-Altitude Defense Field Shield',
      ...
      imageAlt: 'Portable Low-Altitude Defense Field Shield for temporary site protection',
  ...
  faqs: [
    { question: 'Is a Site Protection system one product?', answer: 'Not necessarily. A complete configuration can combine fixed, portable or mobile sensors, command software and directional or omni-directional RF suppressors selected for the site.' },
  ],
