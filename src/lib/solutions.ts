...
export const getAllSolutions = unstable_cache(
    ...
    ['all-solutions-uav-refresh-20260529-substation-main-exact-v4'],
...
export const getSolutionById = unstable_cache(
    ...
    ['solution-detail-uav-refresh-20260529-substation-main-exact-v4'],
    { revalidate: 3600, tags: ['solutions'] }
);
...
export const getAllSolutionHandles = unstable_cache(
    ...
    ['solution-handles-uav-refresh-20260529-substation-main-exact-v4'],
    { revalidate: 3600, tags: ['solutions'] }
);
