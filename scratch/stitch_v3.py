...
def stitch():
    banner_w = 1920
    banner_h = 400  # Optimized for 40vh height
    cell_w = 480
    cell_h = 200  # Each row is 200px (Total 400)
    
    banner = Image.new('RGB', (banner_w, banner_h), (26, 42, 68))
    source_dir = 'public/case_banner'
    output_path = 'public/cases/case_banner_final_v3.png'
    ...
    for i in range(8):
        ...
        try:
            with Image.open(img_path) as img:
                ...
                # Adjust crop anchor to avoid white borders and keep drones central
                anchor_y = 0.5
                if img_id == 5: anchor_y = 0.6
                if img_id == 3: anchor_y = 0.4
    ...
    print(f"Successfully saved 1920x400 banner at {output_path}")
