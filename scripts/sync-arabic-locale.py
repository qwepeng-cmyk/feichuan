...
EXACT = {
    ...
    "Industrial UAV platforms, airspace situational awareness, event records, and compliant response workflows for infrastructure, utilities, and public operations.": "منصات UAV صناعية، ووعي ميداني بالمجال الجوي، وسجلات أحداث، وسير عمل متوافق للاستجابة في البنية التحتية والمرافق والعمليات العامة.",
    ...
    "Contact Us": "اتصل بنا",
    "Talk with our team about UAV platforms, airspace monitoring equipment, inspection workflows, and project-specific deployment needs.": "تحدث مع فريقنا حول منصات UAV ومعدات مراقبة المجال الجوي وسير عمل التفتيش واحتياجات النشر الخاصة بالمشروع.",
