...
const publicPaths = [
  ...
  '/es/products',
  '/ar/products',
  '/en/products/handheld-drone-net-launcher',
  '/ru/products/handheld-drone-net-launcher',
  '/es/products/handheld-drone-net-launcher',
  '/ar/products/handheld-drone-net-launcher',
...
const restrictedPaths = [
  ...
  '/en/products/drone-laser-engagement-system',
  '/ru/products/drone-laser-engagement-system',
  '/es/products/drone-laser-engagement-system',
  '/ar/products/drone-laser-engagement-system',
