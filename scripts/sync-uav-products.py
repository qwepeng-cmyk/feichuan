...
def mission_records() -> list[ProductRecord]:
    ...
    records = [
        ProductRecord(
            ...
            detail_html_en=details_en(["Covers planning survey, construction acceptance, routine inspection, and disaster-response patrol workflows.", "Supports LiDAR tree-clearance analysis, ortho/oblique imagery, and 3D modeling.", "Designed for mountainous, hilly, and forested routes where manual inspection is slow or risky."], public_path("medium-long-range-uav-inspection-system.webp")),
