        ...
        "en": {
            ...
            "sections": [
                ("Product Introduction", [
                    ...
                    "It inspects transformers, structures, lightning rods, busbars, insulators, transformers, and station corridors using HD visible-light imaging and infrared temperature measurement, completing the process from task issue to autonomous flight, data collection, AI analysis, and work-order closure."
                ]),
                ("Functional Characteristics", [
        ...
        "en": {
            ...
            "sections": [
                ("Product Introduction", [
                    ...
                    "It collects image and temperature data and completes a full process from route planning and autonomous aerial imaging to defect filing and report output."
                ]),
                ("Functional Characteristics", [
                    ...
                    "Integrated multi-payload detection: visible-light and thermal payloads collect appearance defects and temperature anomalies in one process.",
...
DOCX_EXACT_EN = {
    ...
    "集成可见光、热红外载荷，同步完成外观缺陷、温度异常多维度检测。": "Visible-light and thermal infrared payloads are integrated to detect appearance defects and temperature anomalies in one process.",
...
LEXICON_EN = {
    ...
    "螺旋桨固定螺丝": "Propeller Fixing Screws", "螺旋桨": "Propeller", "电池": "Battery", "电机": "Motor", "天线": "Antenna", "非传": "Beijing Non-traditional Equipment Technology Co., Ltd.", "北京": "Beijing",
...
LEXICON_RU = {
    ...
    "螺旋桨固定螺丝": "винты крепления пропеллера", "螺旋桨": "пропеллер", "电池": "аккумулятор", "电机": "двигатель", "天线": "антенна", "非传": "Beijing Non-traditional Equipment Technology Co., Ltd.", "北京": "Пекин",
