"use strict";(()=>{var e={};e.id=6893,e.ids=[6893],e.modules={30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},57147:e=>{e.exports=require("fs")},71017:e=>{e.exports=require("path")},74649:(e,T,r)=>{r.r(T),r.d(T,{headerHooks:()=>X,originalPathname:()=>l,patchFetch:()=>y,requestAsyncStorage:()=>c,routeModule:()=>d,serverHooks:()=>m,staticGenerationAsyncStorage:()=>p,staticGenerationBailout:()=>N});var a={};r.r(a),r.d(a,{DELETE:()=>u,GET:()=>o,PUT:()=>i});var t=r(95419),E=r(69108),_=r(99678),n=r(78070),s=r(29976);async function o(e,{params:T}){try{let e=s.Z.prepare("SELECT raw_json FROM solutions WHERE handle = ?").get(T.id);if(!e)return n.Z.json({success:!1,error:"Not found"},{status:404});return n.Z.json({success:!0,data:JSON.parse(e.raw_json)})}catch(e){return n.Z.json({success:!1,error:"Server error"},{status:500})}}async function i(e,{params:T}){try{let r=await e.json(),a=JSON.stringify(r);return s.Z.prepare(`
            UPDATE solutions 
            ...
            WHERE handle = ?
        `).run(r.product_name_en||r.product_name,r.product_name_ru||"",r.category_id||"",r.category_name||"",r.category_primary||"",r.main_image||"",r.summary_en||"",r.summary_ru||"",r.key_application_en||"",r.key_application_ru||"",r.key_parameter_1_en||"",r.key_parameter_1_ru||"",r.key_parameter_2_en||"",r.key_parameter_2_ru||"",JSON.stringify(r.parameters_en||[]),JSON.stringify(r.parameters_ru||[]),r.detail_html_en||"",r.detail_html_ru||"",a,T.id),n.Z.json({success:!0})}catch(e){return n.Z.json({success:!1},{status:500})}}async function u(e,{params:T}){try{return s.Z.prepare("DELETE FROM solutions WHERE handle = ?").run(T.id),n.Z.json({success:!0})}catch(e){return n.Z.json({success:!1},{status:500})}}let d=new t.AppRouteRouteModule({definition:{kind:E.x.APP_ROUTE,page:"/api/admin/solutions/[id]/route",pathname:"/api/admin/solutions/[id]",filename:"route",bundlePath:"app/api/admin/solutions/[id]/route"},resolvedPagePath:"/Users/mattchyi/Documents/Project/fc/src/app/api/admin/solutions/[id]/route.ts",nextConfigOutput:"",userland:a}),{requestAsyncStorage:c,staticGenerationAsyncStorage:p,serverHooks:m,headerHooks:X,staticGenerationBailout:N}=d,l="/api/admin/solutions/[id]/route";function y(){return(0,_.patchFetch)({serverHooks:m,staticGenerationAsyncStorage:p})}},29976:(e,T,r)=>{r.d(T,{Z:()=>d});let a=require("better-sqlite3");var t=r.n(a),E=r(71017),_=r.n(E),n=r(57147),s=r.n(n);let o=_().join(process.cwd(),"data");s().existsSync(o)||s().mkdirSync(o,{recursive:!0});let i=process.env.DATABASE_URL?_().resolve(process.cwd(),process.env.DATABASE_URL):_().join(o,"ntet.db"),u=new(t())(i,{verbose:void 0});u.exec(`
...
`);let d=u}};var T=require("../../../../../webpack-runtime.js");T.C(e);var r=e=>T(T.s=e),a=T.X(0,[1638,6206],()=>r(74649));module.exports=a})();