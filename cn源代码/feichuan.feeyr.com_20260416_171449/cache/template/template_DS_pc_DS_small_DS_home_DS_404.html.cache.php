				...
				<div class="d-flex flex-column flex-center text-center p-10">
					...
					<div class="card card-flush w-lg-650px py-5">
						<div class="card-body py-15 py-lg-20">
							...
							<!--begin::Illustration-->
							<div class="mb-3">
								<img src="<?php echo HOME_THEME_PATH; ?>pc/images/404-error.jpg" class="mw-100 mh-300px theme-light-show" alt="" />
							</div>
							<!--end::Illustration-->
							<!--begin::Text-->
							<div class="fw-semibold fs-6 text-gray-500 mb-7"><?php echo $msg; ?></div>
							<!--end::Text-->
							<!--begin::Link-->
							<div class="mb-0">
								<a href="<?php echo SITE_URL; ?>" class="btn btn-sm btn-primary">回到首页</a>
							</div>
							<!--end::Link-->
						</div>
					</div>
